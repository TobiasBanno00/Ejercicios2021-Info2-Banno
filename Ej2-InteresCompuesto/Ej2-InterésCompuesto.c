...
int main()
{
	...
	printf("---------------------------------------------------------------------------\n");
	printf("Seleccione:\n");
	printf("a- tasas de inter�s del 5 por ciento\n");
	printf("b- tasas de inter�s del 6 por ciento\n");
	printf("c- tasas de inter�s del 8 por ciento\n");
	printf("d- tasas de inter�s del 9 por ciento\n");
	printf("e- tasas de inter�s del 10 por ciento\n");
	scanf("%c",&opcion);
	...
	printf("---------------------------------------------------------------------------\n");
	printf("Seleccionaste la opci�n %c \n",opcion);
	printf("-------------------------- \n");
